            ...
            <Card key={photo.id} className="overflow-hidden group">
              ...
              <div className="relative aspect-[4/3] bg-gray-200">
                ...
                <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-2">
                  <button
                    onClick={() => handleOpenLightbox(filteredPhotos.indexOf(photo))}
                  ...
                  <Link to={`/photo/${photo.id}`}>
                    <button className="p-2 bg-white rounded-full hover:bg-gray-100 transition-colors" title="Page de détails">
                      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                  ...
                  <tr key={photo.id} className="hover:bg-gray-50">
                    ...
                    <td className="px-6 py-4 text-right">
                      <div className="flex items-center justify-end gap-2">
                        ...
                        <Link to={`/photo/${photo.id}`}>
                          <button className="p-2 text-gray-600 hover:text-primary" title="Page de détails">
                            <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                            </svg>
                          </button>
